    ...
    <ResponsivePageLayout>
            ...
            {properties.length === 0 ? (
              ...
              properties.map((property) => (
                ...
                >
                  ...
                  <CardContent sx={{ display: 'flex', gap: 2, alignItems: 'center', flex: 1 }}>
      ...
      {pagination.totalPages > 1 && (
        <Box display="flex" justifyContent="center" mt={3}>
          <Pagination count={pagination.totalPages} page={page} onChange={(_, value) => setPage(value)} />
        </Box>
      )}
